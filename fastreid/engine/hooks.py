...
class LRScheduler(HookBase):
    ...
    def after_epoch(self):
        ...
        if next_iter > self.trainer.warmup_iters and next_epoch > self.trainer.delay_epochs and next_epoch <= self.trainer.t_max_epoch:
            self._scheduler["lr_sched"].step()
        # if next_epoch > self.trainer.t_max_epoch:
        #     self._scheduler["lr_sched"].step(self.trainer.t_max_epoch)
